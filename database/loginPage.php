...
<body class="d-flex flex-column vh-100 bg-dark" >
    ...
    <div class="container d-flex justify-content-center align-items-center mb-5 mt-3">
    <div class="row">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    <form action="login.php" method="POST" class="validated-form" >
                        ...
                        <button class="btn btn-success btn-block text-white"><a href="../Users/register.php" id="register">Register  </a></button>
                    </form>
